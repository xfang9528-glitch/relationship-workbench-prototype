...
- **真实 Issue 授权**：房总于 2026-08-20 已授权；远端版本化 SDD 包与正式 MCP Issue 均已建立，`actual_issue_creation: true`。
...
| I002 | feat(mcp): 增加三人设客户范围与朋友圈只读能力（房总可以核对三个碎银账号的完整好友，并按人设查看真实朋友圈） | PetWebOrg/suiyin_mcp | 碎银 | 不适用 | 不适用（内部发现） | R003、R009、R010 | AC-R003-01、AC-R009-01、AC-R010-01 | T-R003-02、T-R009-02、T-R010-02 | 当前 MCP 没有 persona-filtered read-only moments，原型只能阻断，不能按官方人设查看真实朋友圈 | MCP 按官方人设安全返回真实朋友圈及完整性回执，群聊永不作为朋友圈 fallback | PetWebOrg/suiyin_mcp#19 | created |
...
- [x] 真实 MCP Issue 已创建并回填 Issue Ref。
