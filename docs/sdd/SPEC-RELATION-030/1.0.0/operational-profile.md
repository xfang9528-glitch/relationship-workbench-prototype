...
reviewed_for_spec: SPEC-RELATION-030@1.0.0
...
- **批准关联 SPEC / Plan**：`SPEC-RELATION-030@1.0.0` / `plan.md` 已于 2026-08-20 批准；未签发版本化 task contract 前不得实施。
...
- 微信完整好友 roster、T028 persona-complete 与碎银朋友圈缺能力时必须 blocked/unsupported；本 Profile 不构成工程授权。
